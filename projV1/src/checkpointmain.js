...
k.loadSprite("Character1", "sprites/bean.png")
k.loadSprite("Character2", "sprites/bean.png")
k.loadSprite("Character3", "sprites/bean.png")
k.loadSprite("Character4", "sprites/bean.png")
k.loadSprite("Character5", "sprites/bean.png")
...
k.scene("main", () => {
	...
	k.add([
		text("[green]- Made with 🍩 by mao mao[/green]", {
			width: width(),
			styles: {
				"green": {
					// color: rgb(128, 128, 255),
	...
	addButton("Start", vec2(200, 200), () => k.go("selector"))
	addButton("Quit", vec2(200, 300), () => debug.log("bye"))
})
